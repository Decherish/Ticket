...
<script language="javascript">
	...
	window.navigate("Admin/Index.jsp");
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
 <form name="form1" method="post" action="<%=basePath %>servlet/LoginServlet">
  ...
  <tr>
    <td height="412" valign="top" background="images/bg_img1.jpg"><table height="300" border="0" cellspacing="0">
      ...
      <tr>
        ...
        <td><span class="text_cray1"><img src="images/bg_img2.gif" alt="" height="20" /></span></td>
      ...
      <tr>
        ...
        <td colspan="2"><table width="200" border="0" cellspacing="0">
          <tr>
            ...
            <td>&nbsp;</td>
            <td width="78"><input name="button2"  type="reset"  class="butzc" id="button2"  value="" ></td>
          </tr>
        </table></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
